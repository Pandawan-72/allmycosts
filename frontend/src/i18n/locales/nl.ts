const COMMON = {
  ...
  settings: {
    ...
    notifications: "Betalingsherinneringen", logout: "Uitloggen", version: "Versie", rateApp: "Beoordelen op Google Play", rateAppSub: "Uw mening is erg belangrijk!", bugReport: "Bug melden", bugSubject: "Bugmelding — All My Costs", aboutTitle: "Over de app", aboutApp: "All My Costs", aboutTagline: "Houd uw uitgaven eenvoudig onder controle.", aboutDev: "Ontwikkeld door Retro-Spare — Anthony Gentil", aboutCountry: "Frankrijk",
    backup: {
      section: "BACK-UP",
