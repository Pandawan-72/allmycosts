const LEGAL_EN = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "3. Local data", body: "All your recurring expenses, one-off expenses, receipt photos, and income (default and per-month) are stored exclusively and locally on your device. They are never sent to our servers, except for the text described in article 4 below." },
      ...
      { title: "6. Third-party services", body: "All My Costs uses: Google Sign-In / Firebase (authentication), RevenueCat (Pro purchases), Google Play (payments), open.er-api.com (exchange rates), Anthropic (structuring scanned receipt text, Pro feature)." },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Free and Pro version", body: "Free: up to 6 expenses total (recurring and one-off combined), monthly/yearly total, base currency. Pro (€5.99 one-time): unlimited expenses, statistics, PDF export, unlimited categories, AI-powered receipt scanning, receipt photo storage and sharing." },
