const LEGAL_EN = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "2. Data collected", body: "Free: up to 6 expenses total (recurring and one-off combined), monthly/yearly total, base currency. Pro (one-time purchase, price shown on Google Play): unlimited expenses, statistics, PDF export, unlimited categories, AI-powered receipt scanning, receipt photo storage and sharing." },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Free and Pro version", body: "Free: up to 6 expenses total (recurring and one-off combined), monthly/yearly total, base currency. Pro (one-time purchase, price shown on Google Play): unlimited expenses, statistics, PDF export, unlimited categories, AI-powered receipt scanning, receipt photo storage and sharing." },
