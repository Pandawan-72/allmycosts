const LEGAL_EN = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Free and Pro version", body: "Free: up to 6 expenses total (recurring and one-off combined), monthly/yearly total, base currency. Pro (€3.99 one-time): unlimited expenses, statistics, PDF export, unlimited categories, AI-powered receipt scanning, receipt photo storage and sharing." },
