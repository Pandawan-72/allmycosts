const LEGAL_IT = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Versione gratuita e Pro", body: "Gratuito: fino a 5 spese ricorrenti, totale mensile/annuale, valuta base. Pro (5,99 € acquisto unico): spese illimitate, statistiche, esportazione PDF, categorie illimitate." },
