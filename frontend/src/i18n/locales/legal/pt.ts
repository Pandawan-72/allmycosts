const LEGAL_PT = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "3. Dados locais", body: "Todas as suas despesas recorrentes, despesas pontuais, fotos de recibos e rendimentos (padrão e por mês) são armazenados exclusivamente de forma local no seu dispositivo e nunca enviados para os nossos servidores, exceto o texto descrito no artigo 4." },
      ...
      { title: "6. Serviços de terceiros", body: "All My Costs usa: Google Sign-In / Firebase (autenticação), RevenueCat (compras Pro), Google Play (pagamentos), open.er-api.com (taxas de câmbio), Anthropic (estruturação do texto de recibos digitalizados, funcionalidade Pro)." },
