const LEGAL_FR = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Version gratuite et Pro", body: "Gratuit : jusqu'à 6 dépenses au total (récurrentes et ponctuelles confondues), total mensuel/annuel, devise de base. Pro (5,99 € achat unique) : dépenses illimitées, statistiques, export PDF, catégories illimitées, scan de tickets par IA, stockage et partage des photos de tickets." },
