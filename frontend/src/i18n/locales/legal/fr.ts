const LEGAL_FR = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "2. Données collectées", body: "Gratuit : jusqu'à 6 dépenses au total (récurrentes et ponctuelles confondues), total mensuel/annuel, devise de base. Pro (3,99 € achat unique) : dépenses illimitées, statistiques, export PDF, catégories illimitées, scan de tickets par IA, stockage et partage des photos de tickets." },
