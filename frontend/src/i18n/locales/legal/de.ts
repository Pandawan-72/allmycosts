const LEGAL_DE = {
  ...
  privacy: {
    ...
    sections: [
      { title: "1. Herausgeber", body: "All My Costs wird von All My Costs herausgegeben. Kontakt: support@allmycosts.app." },
      { title: "2. Erhobene Daten", body: "Name, E-Mail-Adresse (Firebase). Google Sign-In: Name, E-Mail, Foto. Keine Bankdaten gespeichert." },
      { title: "3. Lokale Daten", body: "Alle wiederkehrenden Ausgaben und Einnahmen werden ausschließlich lokal auf Ihrem Gerät gespeichert und nie an unsere Server übertragen." },
      { title: "4. Datenverwendung", body: "Wir verwenden Ihre Daten nur für: Konto erstellen und sichern, Pro-Zugang verwalten, Supportanfragen beantworten." },
      { title: "5. Drittanbieterdienste", body: "All My Costs nutzt: Google Sign-In / Firebase (Authentifizierung), RevenueCat (Pro-Käufe), Google Play (Zahlungen), open.er-api.com (Wechselkurse)." },
      { title: "6. Speicherdauer", body: "Firebase-Konto wird aufbewahrt, solange es aktiv ist; auf Anfrage gelöscht. Lokale Daten bei Deinstallation gelöscht." },
      { title: "7. Ihre Rechte (DSGVO)", body: "Auskunft, Berichtigung, Löschung, Portabilität, Widerspruch. Kontakt: support@allmycosts.app." },
      { title: "8. Sicherheit", body: "Authentifizierung über Firebase. Alle Kommunikationen über HTTPS/TLS verschlüsselt." },
      { title: "9. Minderjährige", body: "App nicht für Nutzer unter 16 Jahren bestimmt." },
      { title: "10. Kontakt", body: "support@allmycosts.app" }
    ]
  },
  terms: {
