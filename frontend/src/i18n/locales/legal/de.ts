const LEGAL_DE = {
  lastUpdated: "Letzte Aktualisierung: 15. Juli 2026",
  editor: "All My Costs",
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "2. Erhobene Daten", body: "Kostenlos: bis zu 10 Ausgaben insgesamt (wiederkehrend und einmalig zusammen), monatliche/jährliche Summe, Basiswährung. Pro (Einmalkauf, Preis auf Google Play angezeigt): unbegrenzte Ausgaben, Statistiken, PDF-Export, unbegrenzte Kategorien, KI-gestützter Belegscan, Speicherung und Teilen von Belegfotos." },
      { title: "3. Lokale Daten", body: "Alle wiederkehrenden Ausgaben, einmaligen Ausgaben, Belegfotos und Einkommen werden ausschließlich lokal auf Ihrem Gerät gespeichert und nie an unsere Server übertragen, mit Ausnahme des in Artikel 4 beschriebenen Texts." },
      ...
      { title: "5. Datenverwendung", body: "Wir verwenden Ihre Daten nur für: Pro-Zugang verwalten, Supportanfragen beantworten, gescannten Belegtext strukturieren (Pro-Funktion)." },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Kostenlose und Pro-Version", body: "Kostenlos: bis zu 10 Ausgaben insgesamt (wiederkehrend und einmalig zusammen), monatliche/jährliche Summe, Basiswährung. Pro (Einmalkauf, Preis auf Google Play angezeigt): unbegrenzte Ausgaben, Statistiken, PDF-Export, unbegrenzte Kategorien, KI-gestützter Belegscan, Speicherung und Teilen von Belegfotos." },
      { title: "3. 15 Tage kostenlose Testversion", body: "Bei der ersten Nutzung erhält jeder Nutzer eine 15-tägige kostenlose Testversion mit vollem Pro-Zugang." },
      { title: "4. Pro-Einmalkauf", body: "Pro-Zugang ist als Einmalkauf zum auf Google Play angezeigten Preis verfügbar. Kein Abonnement, keine Folgekosten." },
