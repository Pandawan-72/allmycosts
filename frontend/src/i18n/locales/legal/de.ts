const LEGAL_DE = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "2. Erhobene Daten", body: "Kostenlos: bis zu 6 Ausgaben insgesamt (wiederkehrend und einmalig zusammen), monatliche/jährliche Summe, Basiswährung. Pro (3,99 € Einmalkauf): unbegrenzte Ausgaben, Statistiken, PDF-Export, unbegrenzte Kategorien, KI-gestützter Belegscan, Speicherung und Teilen von Belegfotos." },
