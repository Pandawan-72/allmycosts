const LEGAL_DE = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "7. Ihre Rechte (DSGVO)", body: "Auskunft, Berichtigung, Löschung, Portabilität, Widerspruch. Kontakt: dev@retro-spare.fr." },
      { title: "8. Sicherheit", body: "Authentifizierung über Firebase. Alle Kommunikationen über HTTPS/TLS verschlüsselt." },
      { title: "9. Minderjährige", body: "App nicht für Nutzer unter 13 Jahren bestimmt." },
