const LEGAL_ES = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Versión gratuita y Pro", body: "Gratuito: hasta 6 gastos en total (recurrentes y puntuales combinados), total mensual/anual, divisa base. Pro (pago único, precio mostrado en Google Play): gastos ilimitados, estadísticas, exportación PDF, categorías ilimitadas, escaneo de tickets por IA, almacenamiento y uso compartido de fotos de tickets." },
