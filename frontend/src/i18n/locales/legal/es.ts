const LEGAL_ES = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "2. Datos recopilados", body: "Gratuito: hasta 10 gastos en total (recurrentes y puntuales combinados), total mensual/anual, divisa base. Pro (pago único, precio mostrado en Google Play): gastos ilimitados, estadísticas, exportación PDF, categorías ilimitadas, escaneo de tickets por IA, almacenamiento y uso compartido de fotos de tickets." },
      ...
      { title: "5. Uso de datos", body: "Usamos tus datos solo para: gestionar tu acceso Pro, responder solicitudes de soporte, y estructurar el texto de los tickets escaneados (función Pro)." },
      ...
      { title: "7. Conservación", body: "Datos locales (incluidas fotos de tickets) eliminados al desinstalar. El texto enviado para el escaneo no se conserva más allá del procesamiento inmediato." },
      { title: "8. Tus derechos (RGPD)", body: "Acceso, rectificación, supresión, portabilidad, oposición. Contacto: dev@retro-spare.fr." },
      { title: "9. Seguridad", body: "Todas las comunicaciones cifradas HTTPS/TLS, incluido el escaneo de tickets. Pagos protegidos por Google Play." },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Versión gratuita y Pro", body: "Gratuito: hasta 10 gastos en total (recurrentes y puntuales combinados), total mensual/anual, divisa base. Pro (pago único, precio mostrado en Google Play): gastos ilimitados, estadísticas, exportación PDF, categorías ilimitadas, escaneo de tickets por IA, almacenamiento y uso compartido de fotos de tickets." },
      ...
      { title: "4. Compra única Pro", body: "El acceso Pro está disponible mediante un pago único al precio mostrado en Google Play. Sin suscripción ni cargos recurrentes." },
      ...
      { title: "7. Uso aceptable", body: "Datos locales (incluidas fotos de tickets) eliminados al desinstalar. El texto enviado para el escaneo no se conserva más allá del procesamiento inmediato." },
      { title: "8. Propiedad intelectual", body: "La Aplicación y su contenido son propiedad exclusiva de All My Costs." },
      { title: "9. Limitación de responsabilidad", body: "Todas las comunicaciones cifradas HTTPS/TLS, incluido el escaneo de tickets. Pagos protegidos por Google Play." },
