const LEGAL_ES = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "3. Datos locales", body: "Todos tus gastos recurrentes, gastos puntuales, fotos de tickets e ingresos (predeterminado y por mes) se almacenan exclusivamente de forma local en tu dispositivo y nunca se envían a nuestros servidores, salvo el texto descrito en el artículo 4." },
      ...
      { title: "6. Servicios de terceros", body: "All My Costs usa: Google Sign-In / Firebase (autenticación), RevenueCat (compras Pro), Google Play (pagos), open.er-api.com (tipos de cambio), Anthropic (estructuración del texto de tickets escaneados, función Pro)." },
