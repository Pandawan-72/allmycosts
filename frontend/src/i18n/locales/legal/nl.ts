const LEGAL_NL = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "5. Gegevensgebruik", body: "We gebruiken uw gegevens alleen voor: Pro-toegang beheren, supportverzoeken beantwoorden, gescande bontekst structureren (Pro-functie)." },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "3. 15 dagen gratis proefperiode", body: "Bij het eerste gebruik krijgt elke gebruiker een gratis proefperiode van 15 dagen met volledige Pro-toegang." },
