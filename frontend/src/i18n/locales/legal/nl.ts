const LEGAL_NL = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "3. Lokale gegevens", body: "Al uw terugkerende uitgaven, eenmalige uitgaven, bonfoto’s en inkomen (standaard en per maand) worden uitsluitend lokaal op uw apparaat opgeslagen en nooit naar onze servers verzonden, behalve de tekst beschreven in artikel 4." },
      ...
      { title: "6. Diensten van derden", body: "All My Costs gebruikt: Google Sign-In / Firebase (authenticatie), RevenueCat (Pro-aankopen), Google Play (betalingen), open.er-api.com (wisselkoersen), Anthropic (structureren van gescande bontekst, Pro-functie)." },
