const LEGAL_NL = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Gratis en Pro-versie", body: "Gratis: tot 5 terugkerende uitgaven, maandelijks/jaarlijks totaal, basisvaluta. Pro (€ 5,99 eenmalige aankoop): onbeperkte uitgaven, statistieken, PDF-export, onbeperkte categorieën." },
